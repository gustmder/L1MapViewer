...
namespace L1MapViewer.Localization
{
    ...
    public static class Strings_enUS
    {
        public static Dictionary<string, string> GetStrings() => new()
        {
            ...
            { "Material_SelectToView", "Select a material to view details" },
            { "Material_InfoName", "Name" },
            { "Material_InfoSize", "Size" },
            { "Material_InfoLayers", "Layers" },
            { "Material_InfoFileSize", "File size" },
            { "Material_InfoFile", "File" },
            { "Material_CannotRead", "Cannot read material" },
            { "Material_NoLayers", "None" },
            { "Material_PleaseSelect", "Please select a material" },
            { "Material_CannotLoad", "Cannot load material" },
            { "Material_LoadFailed", "Failed to load material" },
            { "Material_OpenFileTitle", "Open material file" },
            { "Material_CannotParse", "Cannot parse material file" },
            { "Material_OpenFailed", "Failed to open file" },
            { "Material_ConfirmDelete", "Are you sure you want to delete \"{0}\"?" },
            { "Material_DeleteFailed", "Delete failed" },
            { "Material_SelectFolder", "Select material library folder" },
            { "Material_SearchPlaceholder", "Search materials..." },
            { "Dialog_Hint", "Hint" },
            { "Dialog_Error", "Error" },
