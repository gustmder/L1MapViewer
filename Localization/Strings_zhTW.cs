...
namespace L1MapViewer.Localization
{
    ...
    public static class Strings_zhTW
    {
        public static Dictionary<string, string> GetStrings() => new()
        {
            ...
            { "Material_SelectToView", "選擇素材以查看詳細資訊" },
            { "Material_InfoName", "名稱" },
            { "Material_InfoSize", "範圍" },
            { "Material_InfoLayers", "圖層" },
            { "Material_InfoFileSize", "檔案大小" },
            { "Material_InfoFile", "檔案" },
            { "Material_CannotRead", "無法讀取素材" },
            { "Material_NoLayers", "無" },
            { "Material_PleaseSelect", "請選擇素材" },
            { "Material_CannotLoad", "無法載入素材" },
            { "Material_LoadFailed", "載入素材失敗" },
            { "Material_OpenFileTitle", "開啟素材檔案" },
            { "Material_CannotParse", "無法解析素材檔案" },
            { "Material_OpenFailed", "開啟檔案失敗" },
            { "Material_ConfirmDelete", "確定要刪除素材 \"{0}\"？" },
            { "Material_DeleteFailed", "刪除失敗" },
            { "Material_SelectFolder", "選擇素材庫資料夾" },
            { "Material_SearchPlaceholder", "搜尋素材..." },
            { "Dialog_Hint", "提示" },
            { "Dialog_Error", "錯誤" },
            { "Dialog_ConfirmDelete", "確認刪除" },
